@extends('home.layout')
@section('title','Tentang SI Kuwalu')
@section('meta-tags')
    <meta name="description" content="Selamat datang di SI Kuwalu! Kami adalah penyedia furnitur berkualitas tinggi yang mengutamakan kenyamanan dan gaya. Misi kami adalah menghadirkan produk yang menarik, tahan lama, dan fungsional untuk setiap rumah.">
    <meta name="keywords" content="tentang SI Kuwalu">
@endsection
@section('content')
    <div class="product-section">
        <div class="container" style="padding: 30vh 0;">
            ...
            <p>
                Selamat datang di SI Kuwalu! Kami adalah penyedia furniture berkualitas tinggi yang mengutamakan
