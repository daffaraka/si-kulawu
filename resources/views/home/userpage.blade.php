...
<head>
    ...
    <link href="{{ asset('home/assets/lib/owlcarousel/assets/owl.carousel.css') }}" rel="stylesheet">
...
<body>
    <!-- Topbar Start -->
    @include('home.partials.topbar-start')
    <!-- Topbar End -->
    ...
    <div class="container-fluid mb-5">
        <div class="row border-top px-xl-5">
            @include('home.partials.categories-section')
            <div class="col-lg-9">
                @include('home.partials.header')
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            <img class="img-fluid" src="{{ asset('home/assets/img/carousel-image-1.jpg') }}" alt="Image">
                        ...
                        <div class="carousel-item" style="height: 410px;">
                            <img class="img-fluid" src="{{ asset('home/assets/img/carousel-image-2.jpg') }}" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First
                                        Order</h4>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        <div
                            ...
                            <img class="img-fluid w-100" src="{{ asset('produk/' . $product->gambar_produk) }}" alt="">
                        </div>
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3"> {{ $product->nama_produk }} </h6>
                            <div class="d-flex justify-content-center">
                                <h6>Rp. {{ $product->harga_produk }}</h6>
    ...
    <script src="{{ asset('home/assets/mail/jqBootstrapValidation.min.js') }}"></script>
    <script src="{{ asset('home/assets/mail/contact.js') }}"></script>
